...
@WebServlet("/RemoveCoOwner")
public class RemoveCoOwner extends HttpServlet {
	
	private static final long serialVersionUID = 1L;
	
	private ControllerModel controllerRegistration;
       
    public RemoveCoOwner() {
        super();
        this.controllerRegistration = ControllerModel.getInstance();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			this.controllerRegistration.deleteCoOwner(carName, loginBean, coOwnerUsername);
